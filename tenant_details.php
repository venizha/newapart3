...
$balance = ($waterBillPaymentStatus == 0 ? $waterBillAmount : 0) +
            ($electricityBillPaymentStatus == 0 ? $electricityBillAmount : 0) +
            ($maintenanceFeesPaymentStatus == 0 ? $maintenanceFeesAmount : 0) +
            $tenantDetails['rent_amt'];
    ...
    <div>
      ...
      <table>
        ...
        <tr>
          <td>Rent</td>
          <td><?php echo $tenantDetails['rent_amt']; ?></td>
          <td style="color: <?php echo ($tenantDetails['payment_status'] == 1) ? 'green' : 'red'; ?>">
            <?php echo ($tenantDetails['payment_status'] == 1) ? 'Paid' : 'Unpaid'; ?>
            <td>  <?php echo ($tenantDetails['payment_status']== 1) ? '-' : 
        ...
        <tr>
          ...
          <td style="color: <?php echo ($waterBillPaymentStatus == 1) ? 'green' : 'red'; ?>">
            ...
            <td>  <?php echo ($waterBillPaymentStatus== 1) ? '-' : 
        ...
        <tr>
          ...
          <td>  <?php echo ($electricityBillPaymentStatus == 1) ? '-' : 
        ...
        <tr>
          ...
          <td style="color: <?php echo ($maintenanceFeesPaymentStatus == 1) ? 'green' : 'red'; ?>">
            ...
            <td>  <?php echo ($maintenanceFeesPaymentStatus == 1) ? '-' : 
