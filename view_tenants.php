...
while ($row = pg_fetch_assoc($result)) {
    ...
    $row['rent_amount_paid'] = ($row['rent_amount_paid'] == 1) ? 'Paid' : 'Not Paid';  // Assuming rent_amt is the actual amount paid for rent
